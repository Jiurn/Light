...
export function Button({small, gray, className="", ...props}: ButtonProps) {
    ...
    return <button className={`rounded-full transition-colors duration-200 disabled:cursor-not-allowed disabled:opacity-60 text-white ${sizeClasses} ${colorClasses} ${className}`} {...props}></button>
}